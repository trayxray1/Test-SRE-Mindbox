...
Полноценное решение тестового задания Mindbox. Проект демонстрирует Kubernetes, отказоустойчивости, автоматического масштабирования и production-ready решений.
