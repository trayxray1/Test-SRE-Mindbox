...
Это полноценное решение тестового задания для позиции SRE в Mindbox. Проект демонстрирует Kubernetes, отказоустойчивости, масштабируемости и оптимизации ресурсов.
